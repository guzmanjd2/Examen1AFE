...
<div class="container mt-3">
    <div class="row d-flex justify-content-center ">
        <div class="col-md-8">
            ...
            <div style="position: fixed; z-index: 100; left: 67.5%;">
                <img class="card-img-top w-50 h-50" src="{{ asset('images/klipartz.com.png') }}" alt="Card image cap">
            </div>
            ...
            <div class="card border-0 pt-3 pb-5">
                ...
                <div class="card-header border-0">
                    ...
                    <img class="card-img-top w-25 h-25" src="{{ asset('images/3071357.jpg') }}" alt="Card image cap">
                </div>
                </div>
                <div class="card-body">
